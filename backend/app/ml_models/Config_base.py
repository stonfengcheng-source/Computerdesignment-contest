...
class Config_base(object):
    ...
    def __init__(self, model_name, dataset):
        ...
        self.train_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/multi_task_train.json'                                # 训练集
        self.dev_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/multi_task_dev.json'                                    # 验证集
        self.test_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/multi_task_test.json'                                  # 测试集

        self.vocab_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/vocab.pkl' 
        self.lexicon_path = path.dirname(path.dirname(__file__))+'/'+ '/data/lexicon/'        # 数据集、模型训练结果                               # 词表
